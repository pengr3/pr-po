...
must_haves:
  ...
  key_links:
    ...
    - from: "app/firebase.js"
      to: "app/auth.js"
      via: "initialize auth observer on load"
      pattern: "initAuthObserver"
---
...
<task type="auto">
  ...
  <action>
    ...
    6. Import and call initAuthObserver() from auth.js at the end of the file:
       ```javascript
  ...
  <verify>
    ...
    - initAuthObserver is called (check console for auth state logs)
  </verify>
  <done>
