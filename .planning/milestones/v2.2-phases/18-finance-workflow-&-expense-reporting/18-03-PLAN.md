...
- Transport requests filtered by finance_status='Approved' to exclude rejected TRs
  ...
  <verify>
1. Read finance.js imports (line 7) → confirm formatCurrency is included
2. Read finance.js line 16 → confirm projectExpenses variable already exists
...
11. Verify over-budget projects show negative remaining in red with ⚠️
