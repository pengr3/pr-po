...
- [ ] 46-03-PLAN.md — Gap closure: remove dead procurement-base.js + mark CLN-02 complete
...
| 46. Code Cleanup and MRF Fix | 3/3 | Complete    | 2026-02-28 | - |

### Phase 47: Fix sortable headers, login logo, and urgency propagation to finance

**Goal:** Finance Pending Approvals tables have sortable column headers, login page shows company logo, and PR documents carry urgency level from parent MRF
**Requirements**: SORT-01, SORT-02, BRD-02, URG-01
**Depends on:** Phase 46
**Plans:** 3/3 plans complete

Plans:
- [x] 47-01-PLAN.md — Sortable headers for Material PRs and Transport Requests tables in finance.js (SORT-01, SORT-02)
- [ ] 47-02-PLAN.md — Login page logo replacement + urgency_level propagation to PR addDoc (BRD-02, URG-01)

### Phase 47.2: Fix Create MRF Requestor field to auto-fill with logged-in user name (INSERTED)

**Goal:** Procurement > Create MRF form pre-fills the Requestor Name field with the logged-in user's full name, matching the behavior of the standalone MRF form
**Requirements**: MRF-02
**Depends on:** Phase 47
**Plans:** 1/1 plans complete

Plans:
- [ ] 47.2-01-PLAN.md — Pre-fill requestor_name from getCurrentUser() in createNewMRF() (MRF-02)

### Phase 47.1: Add sortable headers to Procurement Records tab (INSERTED)

**Goal:** Procurement Records table has sortable column headers (MRF ID, Date Needed, MRF Status) so users can reorder records by key fields
**Requirements**: SORT-03
**Depends on:** Phase 47
**Plans:** 2/2 plans complete

Plans:
- [ ] 47.1-01-PLAN.md — Sort state, sort function, sortable headers in renderPRPORecords() (SORT-03)

### Phase 48: Improve loading speed and optimize performance under heavy data load

**Goal:** App loading speed and perceived performance are optimized for 500-2000 records per collection with Firebase offline persistence, skeleton loading screens across all views, stale-while-revalidate for dashboard stats, and parallel data fetching
**Requirements**: PERF-01, PERF-02, PERF-03, PERF-04, PERF-05
**Depends on:** Phase 47
**Plans:** 5/5 plans complete

Plans:
- [x] 48-01-PLAN.md — Firebase offline persistence + skeleton CSS infrastructure + skeletonTableRows() utility (PERF-01, PERF-02)
- [x] 48-02-PLAN.md — Skeleton screens + parallel init for procurement.js/finance.js + stale-while-revalidate for home.js (PERF-03, PERF-04)
- [x] 48-03-PLAN.md — Skeleton screens for all remaining views + in-memory reference data cache (PERF-02, PERF-05)
- [x] 48-04-PLAN.md — Reference data TTL caching for loadProjects/loadServicesForNewMRF/loadSuppliers (PERF-05)
- [ ] 48-05-PLAN.md — Gap closure: fix TTL early-return rendering + listener dedup + records caching (PERF-02, PERF-05)
