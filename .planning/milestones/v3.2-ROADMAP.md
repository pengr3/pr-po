...
- [ ] 64-04-PLAN.md — Gap closure: My Requests proof column, REQUIREMENTS.md PROOF-03 update
...
| 65. RFP + Payables Tracking | 5/5 | Complete   | 2026-03-18 | - |
...
### Phase 77.2: Polish Home Graph Proportions and Legend Sizing (INSERTED)
...
- [x] 78-02-PLAN.md — Wire MRF dropdowns (mrf-form.js + procurement.js) for clientless projects + project_id denormalization on MRF/PR/PO/TR/RFP writes
