...
result: pass
enhancement: "User requested rejection reason be included in the notification body."
...
result: pass
enhancement: "User requested that meaningful changes to Projected Cost and Contract Cost on a project also trigger notifications to assigned personnel."
...
- truth: "MRF rejection notification body should include the rejection reason entered by the rejecter."
  status: enhancement
  reason: "User requested during UAT Test 1 — base notification fires correctly, but reason text is not surfaced in the notification."
  severity: minor
  test: 1
  artifacts: []
  missing: []

- truth: "Meaningful changes to Projected Cost and Contract Cost on a project/service should trigger notifications to assigned personnel (similar to project_status changes)."
  status: enhancement
  reason: "User requested during UAT Test 7 — only project_status currently triggers notifications; cost-field changes are equally significant to assigned personnel."
  severity: minor
  test: 7
  artifacts: []
  missing: []
