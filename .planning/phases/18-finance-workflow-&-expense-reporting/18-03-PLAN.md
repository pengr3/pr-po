...
- Over-budget projects highlighted in red with ⚠️ warning icon
...
3. Verify only 3 tabs visible: Pending Approvals, Purchase Orders, Project List
4. Click "Project List" tab
5. Verify table loads with columns: Project Name, Client, Budget, Total Expense, Remaining, Status
6. Verify "Refresh Totals" button exists in header
7. Click a project row
8. Verify expense modal opens with:
...
9. Verify over-budget projects show negative remaining in red with ⚠️
10. Close modal and click "Refresh Totals" button
11. Verify table refreshes (loading spinner appears briefly)
12. Open browser DevTools Console
13. Verify no errors related to Historical Data tab or history-section
  </verify>
  <done>
Finance view has 3 tabs (Historical Data removed), Project List displays expense table with aggregated totals, expense modal shows category breakdown with scorecards
  </done>
</task>
