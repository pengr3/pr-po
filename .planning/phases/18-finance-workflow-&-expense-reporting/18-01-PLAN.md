...
<task type="auto">
  ...
  <action>
**Step 0: Verify serverTimestamp import exists**
Check that line 6 of finance.js includes serverTimestamp in the import statement:
```javascript
...
```
If serverTimestamp is NOT in the import, add it to the existing import statement.
...
**Why these changes:**
- Step 0 ensures serverTimestamp import exists before using it in code
