...
- [ ] **Phase 87: Proposal Lifecycle (with proposal-event notifications)** — `proposals` collection, internal approval workflow + audit trail, document upload + versioning to Firebase Storage, client communication log, proposal-event notifications (NOTIF-09, NOTIF-10), proposal-driven project-status transitions (3/5 plans complete — Plan 03: state-machine transitions Submit/Approve/Reject/Sent/ClientApproved/Loss with writeBatch + NOTIF-09/NOTIF-10)
