...
- [ ] **Phase 87: Proposal Lifecycle (with proposal-event notifications)** — `proposals` collection, internal approval workflow + audit trail, document upload + versioning to Firebase Storage, client communication log, proposal-event notifications (NOTIF-09, NOTIF-10), proposal-driven project-status transitions (5/5 plans code complete — Plan 05: comms log inline Add Entry with per-entry optional attachment; all stubs replaced; awaiting UAT)
...
**Plans**: 5 plans (planned 2026-05-11)
  ...
  - [ ] 87-05-PLAN.md — Comms Log inline Add Entry form with optional per-entry attachment + end-of-phase UAT checkpoint (PROP-08) — Wave 4 (code complete; awaiting UAT)
**UI hint**: yes
...
| 87 | v4.0 | 5/5 | Code complete — UAT pending (Plans 01-05 shipped, Task 4 checkpoint) | 2026-05-11 |
