...
- [ ] **Phase 87: Proposal Lifecycle (with proposal-event notifications)** — `proposals` collection, internal approval workflow + audit trail, document upload + versioning to Firebase Storage, client communication log, proposal-event notifications (NOTIF-09, NOTIF-10), proposal-driven project-status transitions (4/5 plans complete — Plan 04: attachment widget with link/file upload to Firebase Storage + ATTACHMENT_REPLACED audit entries)
