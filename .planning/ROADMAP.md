...
- [ ] 113-02-PLAN.md — W2: deploy indexes (wait for Enabled) then rules to production — blocking human gate
...
- [ ] 113-04-PLAN.md — W4: projects.js / services.js / service-detail.js — scoped portfolio listeners + 4 sync call sites removed
- [ ] 113-05-PLAN.md — W4: project-detail.js / project-plan.js / expense-modal.js — paired project_code lookups + preloaded-doc breakdown + 3 sync call sites removed
- [ ] 113-06-PLAN.md — W4: mrf-form.js / procurement.js — scoped MRF pickers, services Shape-E retirement, PO-Delivered doc-ID journal lookup
