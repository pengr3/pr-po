...
export const TYPE_META = {
    MRF_APPROVED:          { label: 'MRF Approved',          icon: svg('<path d="M4.5 12.75l6 6 9-13.5"/>'), color: '#059669', action_required: false, target_route: '#/procurement/records' },
    MRF_REJECTED:          { label: 'MRF Rejected',          icon: svg('<path d="M6 18L18 6M6 6l12 12"/>'), color: '#ef4444', action_required: false, target_route: '#/procurement/records' },
    PR_REVIEW_NEEDED:      { label: 'PR Review Needed',      icon: svg('<path d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/>'), color: '#f59e0b', action_required: true, target_route: '#/finance' },
    TR_REVIEW_NEEDED:      { label: 'TR Review Needed',      icon: svg('<path d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/>'), color: '#f59e0b', action_required: true, target_route: '#/finance' },
    ...
    PROJECT_STATUS_CHANGED:{ label: 'Project Status',        icon: svg('<path d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99"/>'), color: '#1a73e8', action_required: false, target_route: '#/projects' },
    PROJECT_COST_CHANGED:  { label: 'Project Cost',          icon: svg('<path d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>'), color: '#1a73e8', action_required: false, target_route: '#/projects' },
    REGISTRATION_PENDING:  { label: 'Registration Pending',  icon: svg('<path d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z"/>'), color: '#64748b', action_required: true, target_route: '#/admin?section=user-management' },
    PROPOSAL_SUBMITTED:    { label: 'Proposal Submitted',    icon: svg('<path d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"/>'), color: '#1a73e8', action_required: true, target_route: '#/proposals' },
    PROPOSAL_DECIDED:      { label: 'Proposal Decided',      icon: svg('<path d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z"/>'), color: '#059669', action_required: false, target_route: '#/proposals' },
    // Phase 84.1 — procurement-side audience triggers
    MRF_SUBMITTED:         { label: 'New MRF',               icon: svg('<path d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"/>'), color: '#1a73e8', action_required: false, target_route: '#/procurement/mrfs' },
    PR_DECIDED:            { label: 'PR Decision',           icon: svg('<path d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>'), color: '#059669', action_required: false, target_route: '#/procurement/records' },
    TR_DECIDED:            { label: 'TR Decision',           icon: svg('<path d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z"/>'), color: '#059669', action_required: false, target_route: '#/procurement/records' },
 ...
 */
export async function createNotification({ user_id, type, message, link, source_collection = '', source_id = '', object_name = '', actor_name = '' }) {
 ...
 */
export async function createNotificationForRoles({ roles, type, message, link, source_collection = '', source_id = '', object_name = '', actor_name = '', excludeActor = true }) {
 ...
 */
export async function createNotificationForUsers({ user_ids, type, message, link, source_collection = '', source_id = '', object_name = '', actor_name = '', excludeActor = false }) {
