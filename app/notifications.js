...
export const TYPE_META = {
    ...
    PROPOSAL_SUBMITTED:    { label: 'Proposal Submitted',    icon: svg('<path d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"/>'), color: '#1a73e8', action_required: true, target_route: '#/' },
    PROPOSAL_DECIDED:      { label: 'Proposal Decided',      icon: svg('<path d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z"/>'), color: '#059669', action_required: false, target_route: '#/' },
    // Phase 84.1 — procurement-side audience triggers
